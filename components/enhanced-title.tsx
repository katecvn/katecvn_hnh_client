...
export const TitleHome = ({ children, className }: TextProps) => {
  return (
    <div className="flex items-center justify-center mt-1 mb-8 ">
      ...
      w-2 h-[22px] bg-emerald-600  rotate-180
    ...
    "
        ...
        <span
          className={cn(
            'relative z-10 bg-gradient-to-r from-green-600/80 via-green-cyan-500/80 to-lime-600/80 text-white px-10 py-3 rounded-b-lg',
            'font-bold uppercase tracking-wide text-xl md:text-lg'
          )}
        >
          {children}
        </span>
...
export const TitleCategory = ({ category }: { category: string }) => {
  return (
    <div className="relative ">
      ...
      >
        <h3
          className="uppercase text-lg md:text-xl font-semibold 
...
export const TitleDetailProduct = ({ title }: { title: string }) => {
  return (
    <div className="p-3 bg-gradient-to-r from-gray-50 via-gray-200 to-gray-50">
      <h2 className="text-center text-xl text-neutral-gray-800 uppercase font-semibold ">
        {title}
      </h2>
    </div>
  );
