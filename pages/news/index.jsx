...
import AnimatedHeroSection from '../../components/banner/news-section';
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      {loading ? (
        ...
        ${isHovered ? 'opacity-30 scale-100' : 'opacity-0 scale-95'} -z-20`}
                    style={{
                    ...
                    {categoriesLoading ? (
                      ...
                      <div className="space-y-2">
                        {categories.map((category, index) => (
                          <div
                            key={category.id}
                            className={`group relative overflow-hidden rounded-xl cursor-pointer hover:bg-blue-100 transition-all duration-300 ease-out transform hover:scale-[1.02] ${
                              selectedCategory === category.id
                                ? 'bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg shadow-blue-500/25'
                                : 'bg-white hover:bg-gradient-to-r hover:from-gray-100 hover:to-blue-300 border border-gray-100 hover:border-blue-200 hover:shadow-md'
                            }`}
