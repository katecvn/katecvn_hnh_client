...
const NewsCard = ({ article, index, row }) => {
  ...
  const getWords = (str) => {
    ...
    const shortName =
      words.length > 20 ? words.slice(0, 28).join(' ') + '…' : str;
    return shortName;
  };
    ...
    <AnimatedSection delay={index * 150}>
      ...
      >
        ...
        <div
          ...
          ${isHovered ? 'opacity-30 scale-105' : 'opacity-0 '} -z-20`}
          style={{
...
export default function DynamicNewsGrid({ posts = [], row }) {
